...
function whoseBicycle(diary1, diary2, diary3) {
  let firstSon = Object.values(diary1).reduce((acc, curr) => curr + acc, 0)
  let secondSon = Object.values(diary2).reduce((acc, curr) => curr + acc, 0)
  let thirdSon = Object.values(diary3).reduce((acc, curr) => curr + acc, 0)
  let arr = [firstSon, secondSon, thirdSon]
